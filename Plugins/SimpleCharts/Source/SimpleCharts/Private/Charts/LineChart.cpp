...
ULineChart::ULineChart(const FObjectInitializer& ObjectInitializer)
...
void ULineChart::OnLoadCompleted()
{
...
void ULineChart::SynchronizeProperties()
{
...
#if WITH_EDITOR
const FText ULineChart::GetPaletteCategory()
{
