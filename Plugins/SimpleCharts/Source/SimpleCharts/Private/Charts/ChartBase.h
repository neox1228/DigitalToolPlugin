...
public:
	...
	TSharedPtr<FJsonObject> SetItemStyle(FLinearGradient LinearGradient);
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Chart|Tooltip")
		FColor text_color = FColor(255.0f, 255.0f, 255.0f, 255.0f);
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Chart|Tooltip")
		FColor tip_backgroundColor = FColor(100.0f, 100.0f, 100.0f, 125.0f);
