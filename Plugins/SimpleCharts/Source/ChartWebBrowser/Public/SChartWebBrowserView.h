...
class CHARTWEBBROWSER_API SChartWebBrowserView
...
public:
	...
	SLATE_BEGIN_ARGS(SChartWebBrowserView)
	...
	{ }
		...
		SLATE_ARGUMENT(TOptional<FChartBrowserContextSettings>, ContextSettings)
