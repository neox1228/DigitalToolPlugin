...
class IChartWebBrowserWindowFactory
{
public:
...
struct CHARTWEBBROWSER_API FChartBrowserContextSettings
{
	FChartBrowserContextSettings(const FString& InId)
		: Id(InId)
		, AcceptLanguageList()
...
struct CHARTWEBBROWSER_API FChartCreateBrowserWindowSettings
{

	FChartCreateBrowserWindowSettings()
	...
	TOptional<FChartBrowserContextSettings> Context;
 ...
 */
class CHARTWEBBROWSER_API IChartWebBrowserSingleton
{
public:
	/**
	 * Virtual Destructor
	 */
	virtual ~IChartWebBrowserSingleton() {};

	/** @return A factory object that can be used to construct additional WebBrowserWindows on demand. */
	virtual TSharedRef<IChartWebBrowserWindowFactory> GetWebBrowserWindowFactory() const = 0;
	...
	virtual TSharedPtr<IWebBrowserWindow> CreateBrowserWindow(const FChartCreateBrowserWindowSettings& Settings) = 0;
	...
	virtual bool RegisterContext(const FChartBrowserContextSettings& Settings) = 0;
