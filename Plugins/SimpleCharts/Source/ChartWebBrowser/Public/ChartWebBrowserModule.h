...
class IChartWebBrowserSingleton;

/**
 * WebBrowser initialization settings, can be used to override default init behaviors.
 */
struct CHARTWEBBROWSER_API FWebBrowserInitSettings
{
public:
	/**
...
public:
	...
	{
		return FModuleManager::LoadModuleChecked< IWebBrowserModule >("ChartWebBrowser");
	}
	...
	{
		return FModuleManager::Get().IsModuleLoaded("ChartWebBrowser");
	}
	 ...
	 */
	virtual IChartWebBrowserSingleton* GetSingleton() = 0;
};
