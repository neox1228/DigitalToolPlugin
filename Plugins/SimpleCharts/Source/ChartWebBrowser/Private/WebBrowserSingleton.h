 ...
 */
class FChartWebBrowserSingleton
	: public IChartWebBrowserSingleton
	, public FTickerObjectBase
{
public:

	/** Constructor. */
	FChartWebBrowserSingleton(const FWebBrowserInitSettings& WebBrowserInitSettings);

	/** Virtual destructor. */
	virtual ~FChartWebBrowserSingleton();
...
public:
	...
	virtual TSharedRef<IChartWebBrowserWindowFactory> GetWebBrowserWindowFactory() const override;
	...
	TSharedPtr<IWebBrowserWindow> CreateBrowserWindow(const FChartCreateBrowserWindowSettings& Settings) override;
	...
	virtual bool RegisterContext(const FChartBrowserContextSettings& Settings) override;
...
private:
	...
	TSharedRef<IChartWebBrowserWindowFactory> WebBrowserWindowFactory;
