...
public:
	...
	bool SetConverted(CefRefPtr<ContainerType> Container, KeyType Key, FChartWebJSParam& Param)
	{
		switch (Param.Tag)
		{
	...
	void InvokeJSFunction(FGuid FunctionId, int32 ArgCount, FChartWebJSParam Arguments[], bool bIsError=false) override;
